...
include "includes/header.php";
 ...
 <div class="jl_home_bw">
   <?php
   $x=array();
   $z=$conn->prepare("SELECT * FROM blog   ORDER BY blog_id DESC LIMIT 4");
   $z->execute();
   ...
   <?php
   $r=array();
   $m=$conn->prepare("SELECT * FROM blog   ORDER BY blog_id DESC LIMIT 1");
   $m->execute();
                   ...
                   <div class="jl_m_center blog-style-one blog-small-grid">
                     <div class="jl_m_center_w jl_radus_e">
                      ...
                      <?php foreach($r as $value):?>
                       <div class="text-box">
                         <span class="jl_f_cat">
                           <a class="post-category-color-text" style="background: #eba845;" href="business.php"><?=$value['category']?></a></span>
                         ...
                         <span class='jl_post_meta'>
                          ...
                          <span class='post-date'><i class='jli-pen'></i><?=$value['time_created']?></span>
                           ...
                           <span class='post-read-time'><i class='jli-watch-2'></i>2 Mins read</span></span>";
               ...
               <div id="blockid_72be465" class="block-section jl-main-block" data-blockid="blockid_72be465" data-name="jl_mgrid" data-page_max="11" data-page_current="1" data-author="none" data-order="date_post" data-posts_per_page="6"
                 ...
                 <div class="jl_grid_wrap_f jl_clear_at g_3col">
                   <div class="jl-roww content-inner jl-col3 jl-col-row">
                     ...
                     <?php
                     $a=array();
                     $i=$conn->prepare("SELECT * FROM blog  WHERE  category='Active' ORDER BY blog_id DESC ");
                     $i->execute();
                     ...
                     <?php
                     $b=array();
                     $m=$conn->prepare("SELECT * FROM blog  WHERE category='Business' ORDER BY blog_id DESC ");
                     $m->execute();
...
<!-- </div> -->
                      ...
                      <?php
                      $c=array();
                      $m=$conn->prepare("SELECT * FROM blog  WHERE category='Science' ORDER BY blog_id DESC ");
                      $m->execute();
                      while($n=$m->fetch(PDO::FETCH_BOTH)){
                        $c[]=$n;
                      }
                   ...
                   <?php endforeach; ?>
                      ...
                      <?php endforeach;?>
                        ...
                        <?php
                        $e=array();
                        $m=$conn->prepare("SELECT * FROM blog  WHERE  category='Health' ORDER BY blog_id DESC ");
                        $m->execute();
                        while($n=$m->fetch(PDO::FETCH_BOTH)){
                             $e[]=$n;
                        }
