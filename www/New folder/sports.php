...
$m=$conn->prepare("SELECT * FROM blog  WHERE category='Sports' ORDER BY blog_id DESC ");
$m->execute();
$r=array();
                  ...
                  <div class="single_content_header single_captions_overlay_image_full_width">
                    ...
                    <div class="single_post_entry_content">
                      <span class="meta-category-small">
                        <a class="post-category-color-text" style="background:#d66300" href="#">Sports</a>
                      </span>
                      <?php
                        echo "<h3>";

                          echo "<a href='#'>";
                           $g=$conn->prepare("SELECT * FROM blog  WHERE category='Sports' ORDER BY blog_id DESC LIMIT 1 ");
                           $g->execute();
                            ...
                            <div class="single_section_content box blog_large_post_style">
                              <div class="post_content_w">
                                ...
                                <div class="post_content jl_content">
                                  <?php
                                  $g=$conn->prepare("SELECT * FROM blog  WHERE category='Science' ORDER BY blog_id DESC LIMIT 1 ");
                                  $g->execute();
                                  $h=$g->fetch(PDO::FETCH_BOTH);
                                 echo $h['blog'];
                                 ?>
