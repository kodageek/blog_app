...
$m=$conn->prepare("SELECT * FROM blog  WHERE category='Active' ORDER BY blog_id DESC ");
$m->execute();
$r=array();
                  ...
                  <div class="single_content_header single_captions_overlay_image_full_width">
                    ...
                    <div class="single_post_entry_content">
                      <span class="meta-category-small">
                        <a class="post-category-color-text" style="background:#d66300" href="#">Active</a>
                      </span>
                      <?php
                        echo "<h3>";

                          echo "<a href='#'>";
                           $g=$conn->prepare("SELECT * FROM blog  WHERE category='Active' ORDER BY blog_id DESC LIMIT 1 ");
                           $g->execute();
